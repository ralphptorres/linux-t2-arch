...
prepare() {
  ...
  cd $srcdir/patches
  git config --global user.name "Ralph Torres"
  git config --global user.email "mail@ralphptorr.es"
...
sha256sums=('0a7450fbf1058838f0373ceb926727fc47dd75912783e1977a3560184709634d'
